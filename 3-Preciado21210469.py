...
Nombre del alumno: Preciado Henrndez Andres
...
def plotsignals(u, sysControl, sysCaso, sysTratamiento):
    ...
    fig1.set_size_inches(w, h)
    fig1.tight_layout()
    fig1.savefig('SistemaMusculoesquelético_LazoCerrado.pdf', dpi=600, bbox_inches='tight')
    plt.show()
    ...
    fig2.set_size_inches(w, h)
    fig2.tight_layout()
    fig2.savefig('SistemaMusculoesquelético_LazoAbierto.pdf', dpi=600, bbox_inches='tight')
    plt.show()
